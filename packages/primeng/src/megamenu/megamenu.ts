...
@Component({
    ...
    template: `
        @if (isSubmenuVisible(submenu)) {
            ...
            >
                @if (submenu) {
                    <li [class]="cn(cx('submenuLabel'), getItemProp(submenu, 'class'))" [style]="getItemProp(submenu, 'style')" role="presentation">
                ...
                @for (processedItem of items; track processedItem; let index = $index) {
                    @if (isItemVisible(processedItem) && getItemProp(processedItem, 'separator')) {
                        <li [attr.id]="getItemId(processedItem)" [style]="getItemProp(processedItem, 'style')" [class]="cn(cx('separator'), this.getItemProp(processedItem, 'class'))" role="separator" [attr.data-pc-section]="'separator'"></li>
                    }
                    @if (isItemVisible(processedItem) && !getItemProp(processedItem, 'separator')) {
                        <li
                            #listItem
                                ...
                                @if (!itemTemplate) {
                                    @if (!getItemProp(processedItem, 'routerLink')) {
                                        ...
                                        >
                                            @if (getItemProp(processedItem, 'icon')) {
                                                <span [class]="cn(cx('itemIcon'), getItemProp(processedItem, 'icon'))" [ngStyle]="getItemProp(processedItem, 'iconStyle')" [attr.data-pc-section]="'icon'" [attr.tabindex]="-1"> </span>
                                            }
                                            @if (getItemProp(processedItem, 'escape')) {
                                                <span [class]="cx('itemLabel')" [attr.data-pc-section]="'label'">
                                            ...
                                            @if (getItemProp(processedItem, 'badge')) {
                                                <p-badge [class]="getItemProp(processedItem, 'badgeStyleClass')" [value]="getItemProp(processedItem, 'badge')" />
                                            }
                                                ...
                                                @if (!megaMenu.submenuIconTemplate && !megaMenu._submenuIconTemplate) {
                                                    @if (orientation === 'horizontal' || mobileActive) {
                                                        ...
                                                        @if (orientation === 'vertical') {
                                                            <AngleRightIcon [class]="cx('submenuIcon')" [attr.data-pc-section]="'submenuicon'" [attr.aria-hidden]="true" />
                                                        }
                                                    }
                                                }
                                    ...
                                    @if (getItemProp(processedItem, 'routerLink')) {
                                        ...
                                        >
                                            ...
                                            @if (getItemProp(processedItem, 'escape')) {
                                                <span [class]="cx('itemLabel')">{{ getItemLabel(processedItem) }}</span>
                                            } @else {
                                                <span [class]="cx('itemLabel')" [innerHTML]="getItemLabel(processedItem)" [attr.data-pc-section]="'label'"></span>
                                            }
                                            @if (getItemProp(processedItem, 'badge')) {
                                            ...
                                            @if (isItemGroup(processedItem)) {
                                                @if (!megaMenu.submenuIconTemplate && !megaMenu._submenuIconTemplate) {
                                                    @if (orientation === 'horizontal') {
                                                        <AngleDownIcon [styleClass]="cx('submenuIcon')" [attr.data-pc-section]="'submenuicon'" [attr.aria-hidden]="true" />
                                                    }
                                                    @if (orientation === 'vertical') {
                                                        <AngleRightIcon [styleClass]="cx('submenuIcon')" [attr.data-pc-section]="'submenuicon'" [attr.aria-hidden]="true" />
                                                    }
                                                }
                                                <ng-template *ngTemplateOutlet="megaMenu.submenuIconTemplate || megaMenu._submenuIconTemplate" [attr.data-pc-section]="'submenuicon'" [attr.aria-hidden]="true"></ng-template>
                                            }
