                ...
                <div class="border border-surface rounded-3xl p-6 flex flex-col gap-6">
                                    ...
                                    <div class="px-4 py-0">
                                        ...
                                        <div class="flex flex-wrap gap-2">
                                            @for (file of uploadedFiles; track file) {
                                                <div :key="file.name + file.type + file.size" class="card max-w-[120px] !p-2 m-0 flex flex-col border-1 surface-border items-center gap-2 text-center">
                                                    <div>
                                                        <img role="presentation" [alt]="file.name" :src="file.objectURL" width="100" height="50" />
                                                    </div>
                                                    <span class="font-semibold max-w-[100px] text-ellipsis whitespace-nowrap overflow-hidden">{{ file.name }}</span>
                    ...
                    <div class="flex items-center gap-2">
                        @for (permission of permissions; track permission) {
                            <label [key]="permission.key" [for]="permission.key" class="cursor-pointer flex-1 flex items-center gap-1 p-2 rounded-border border border-surface hover:bg-emphasis transition-all select-none">
                ...
                <div class="border border-surface rounded-3xl p-6">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex items-center gap-4 flex-wrap">
                            @for (data of priceRangePopularSpecs; track data) {
