    ...
    template: `<div style="border-radius: 50px" class="overflow-hidden mb-8">
        ...
        @if (!verified()) {
            <div>
                ...
                >
                <span class="block leading-6 mb-4"
                    >A license can be purchased from <a href="https://primefaces.org/store/designer.xhtml" class="doc-link" rel="noopener noreferrer">PrimeStore</a>, if you do not have a license key, you are still able to experience the Designer in
                    trial mode. Note that in trial mode, downloads, figma to code, migration assistant and cloud storage are not available.</span
                >
        ...
        <div class="flex flex-wrap gap-4">
            ...
            @for (theme of designerService.designer().themes; track theme) {
